...
public class ReservaBanco {
    ...
    public void incluir(Reserva reserva) {
        try {
            ...
            statement.setDate(1, java.sql.Date.valueOf(reserva.getDataReserva()));
            statement.setString(2, reserva.getStatusReserva());
            statement.setDate(3, java.sql.Date.valueOf(reserva.getDataRetirada()));
            statement.setDate(4, java.sql.Date.valueOf(reserva.getDataDevolucao()));
    ...
    public void atualizar(Reserva reserva) {
        try {
            ...
            statement.setDate(2, java.sql.Date.valueOf(reserva.getDataReserva()));
            statement.setString(3, reserva.getStatusReserva());
            statement.setDate(4, java.sql.Date.valueOf(reserva.getDataRetirada()));
            statement.setDate(5, java.sql.Date.valueOf(reserva.getDataDevolucao()));
            statement.setString(6, reserva.getObservacoes());
            statement.setInt(7, reserva.getClienteReserva().getIdCliente());
