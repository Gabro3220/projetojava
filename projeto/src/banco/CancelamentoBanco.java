...
public class CancelamentoBanco {
        ...
        try {
            ...
            if (rs.next()) {
                cancelamento = new Cancelamento(
                    rs.getString("motivoCancelamento"),
                    rs.getDate("dataCancelamento").toLocalDate() // Convertendo java.sql.Date para LocalDate
                );
            }
            rs.close();
            statement.close();
    ...
    public void atualizar(Cancelamento cancelamento) {
        try {
            ...
            statement.setDate(2, java.sql.Date.valueOf(cancelamento.getDataCancelamento()));
